...
public class Compass : MonoBehaviour
{
    ...
    void Awake()
    {
        CharacterController playerCharacterController = FindObjectOfType<CharacterController>();
        DebugUtility.HandleErrorIfNullFindObject<CharacterController, Compass>(playerCharacterController, this);
