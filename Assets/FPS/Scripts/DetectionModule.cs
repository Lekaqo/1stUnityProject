...
{
    [Tooltip("The point representing the source of target-detection raycasts for the enemy AI代表敌方 AI 目标检测射线源的点")]
    public Transform detectionSourcePoint;
    [Tooltip("The max distance at which the enemy can see targets敌人可以看到目标的最大距离")]
    public float detectionRange = 20f;
    [Tooltip("The max distance at which the enemy can attack its target敌人可以攻击其目标的最大距离")]
    public float attackRange = 10f;
    [Tooltip("Time before an enemy abandons a known target that it can't see anymore敌人放弃一个它看不到的已知目标之前的时间")]
    public float knownTargetTimeout = 4f;
    [Tooltip("Optional animator for OnShoot animations OnShoot 动画的可选动画机")]
