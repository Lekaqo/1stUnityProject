...
public class ExplosiveBarrelScript : MonoBehaviour {
    ...
    public AudioSource ExplosiveBarrel;
	...
	private IEnumerator Explode () {
        ...
        ExplosiveBarrel.clip = ExploSound;
        ExplosiveBarrel.Play();

        //AudioSource.PlayClipAtPoint(ExploSound, explosionPos);
        ...
        if (InstantiatePosition)
        {
            Instantiate(InstantiateThing, InstantiatePosition.transform.position, InstantiatePosition.transform.rotation);
        }
